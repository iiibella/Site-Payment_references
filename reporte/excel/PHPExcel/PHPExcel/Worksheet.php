...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
     ...
     *    @param  integer  $pRow2       Numeric row coordinate of the second cell::stringFromColumnIndex($pColumn1) . $pRow1
            . ':' .
     ...
     * @return PHPExcel_Worksheet
     */
    public funxcel_Cell::stringFromColumnIndex($pColumn1) . $pRow1
            . ':' .
            PHPExcel_Cell::stringFromColumnIndex($pColumn2) . $pRow2
        );
    }
